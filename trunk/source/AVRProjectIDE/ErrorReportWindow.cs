...
namespace AVRProjectIDE
{
    public partial class ErrorReportWindow : Form
    {
        ...
        private ErrorReportWindow(Exception ex, string msg)
        {
            ...
            txtException.Text += Environment.NewLine + "Version: " + Properties.Resources.BuildID + Environment.NewLine;
            txtException.Text += Environment.NewLine + "Date: " + DateTime.Now.ToString("MMMM d yyyy") +Environment.NewLine;
            txtException.Text += Environment.NewLine + "OS: " + Environment.OSVersion + Environment.NewLine;
            txtException.Text += Environment.NewLine + "Environment Version: " + Environment.Version + Environment.NewLine;
